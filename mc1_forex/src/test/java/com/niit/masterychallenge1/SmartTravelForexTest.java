...
static final double AED = 20.25;
  ...
  {
    assertEquals(-1, SmartTravelForex.currentExchangeRates(-100, 1),"Enter a non negative number as amount");
    assertEquals(-1, SmartTravelForex.currentExchangeRates(-33, 2),"Enter a non negative number as amount");
    assertEquals(-1, SmartTravelForex.currentExchangeRates(-56, 3),"Enter a non negative number as amount");
    assertEquals(-1, SmartTravelForex.currentExchangeRates(-10, 4),"Enter a non negative number as amount");
    assertEquals(-1, SmartTravelForex.currentExchangeRates(-98, 5),"Enter a non negative number as amount");
